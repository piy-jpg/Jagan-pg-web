...
This directory contains the user-facing static web pages, UI components, interactive 3D WebGL animations, and responsive styles for Jagan PG.

## 📁 File Structure
- `index.html` — Homepage featuring Hero banner, 3D Bloom canvas, Why Us bento cards, Rooms showcase, Amenities, 3D Life at PG carousel, and Heart-shaped Resident Reviews marquee.
- `rooms.html` — Accommodations page with interactive category filter tabs (All, Single, Double, Triple, Quadruple), 3D tilt cards, photo sliders, Pannellum 360 tour modal, and comparison matrix.
